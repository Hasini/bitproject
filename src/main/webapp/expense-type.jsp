		        	...
		        	if(code=="" || code == null || descr == ""|| descr == null){
			        	...
			        	$.ajax({
							...
							success: function (responseText) {
		  						...
		  						window.location.assign('/bitproject/expense-type.jsp');
		        			}   
						});
					}
				});    
		...
		<fieldset>
			<legend>Expense Type</legend>
				<div id="createDiv">
						...
						Expense Type Code : <br>
						<input type="text" name="code" id="code"> <font color="red">*</font><br>
						Expense Type Description :<br> <input type="text" name="descr"
						id="descr"><font color="red">*</font><br>
				...
				<div>
					<label>ExpenseType Code : </label> 
					<select id="eT" name="eT">
						<option>select</option>
					</select>
					<font color="red">*</font><br> <br> 
					Expense Type Description : <br>
