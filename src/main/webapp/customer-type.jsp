					...
					$.ajax ({
						...
						success : function(responseText) {
							if(responseText.success){
								...
								window.location.assign('/bitproject/customer-type.jsp');
								$('input[type="text"]').val('');
							}
...
<body >
	<div id="main">
			<h2></h2>
			Customer / Shop type code : <br><input type="text" name="codeut" id="codeut"> <font color="red">*</font><br>
			Type Description : <br><input type="text" name="descrut" id="descrut"><font color="red">*</font><br>
			<br>
