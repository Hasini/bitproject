				...
				$.ajax({
					...
					success: function (responseText) {
						...
						if (responseText.totarr >= 100000.00){
							alert("Customer is blacklisted until settle the arrears...!");
							$('input[type="text"]').val('');
						}
					}
				});
							...
							success: function (responseText) {
								if (responseText.success){
									...
									if (responseText.remainpay == 0){
										alert("Customer totally paid installment amounts");
										$('input[type="text"]').val('');
									}else 
									{
...
<div class="alert">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
   Cash Book Successfully updated..!
</div>
	<div id="main">
	<fieldset>
	...
	<fieldset>
		<legend>Installment Payment</legend>
			...
			<button type="button" name="refrsh" value="refrsh" id="refrsh" onclick="">Refresh</button>
			<br><br>
